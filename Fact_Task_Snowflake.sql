...
-- ***** cron job task for DAILY_AGGREGATED_SALE ***** --
...
-- truncate SF_TPCDS.INTERMEDIATE.DAILY_AGGREGATED_SALES;
...
-- ***** cron job task for WEEKLY_AGGREGATED_SALES ***** --
...
-- truncate SF_TPCDS.ANALYTICS.WEEKLY_SALES_INVENTORY;
