...
create or replace table SF_TPCDS.ANALYTICS.ITEM_DIM clone TPCDS.RAW.ITEM;

create or replace table SF_TPCDS.ANALYTICS.WAREHOUSE_DIM clone TPCDS.RAW.WAREHOUSE;

create or replace table SF_TPCDS.ANALYTICS.DATE_DIM clone TPCDS.RAW.DATE_DIM;
